...
# TODO check LAN parameters - create LAN network here - make sure to have sources??
...
# sudo ip netns exec ns1 tc qdisc add dev veth1 root netem delay 500ms rate 10mbit
